...
// Lazily create a fresh transporter on each call so env-var updates
// (e.g. SMTP_PASSWORD rotation) are always picked up without a restart.
...
const getSenderAddress = () =>
  ...
  (process.env.SMTP_USER ? `NexBank <${process.env.SMTP_USER}>` : 'NexBank <noreply@nexbank.com>');
